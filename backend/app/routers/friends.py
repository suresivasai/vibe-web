...
from app.models.models import Friend, FriendMessage, User
...
async def send_friend_request(
    ...
    try:
        ...
        target_sid = user_sids.get(str(body.target_user_id))
        if target_sid:
            await sio.emit(
...
async def accept_friend(
    ...
    try:
        ...
        requester_sid = user_sids.get(str(friend.requester_id))
        if requester_sid:
            await sio.emit(
                "friend_accepted",
                {
